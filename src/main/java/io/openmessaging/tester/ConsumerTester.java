...
public class ConsumerTester {
    ...
    static class ConsumerTask extends Thread {
        ...
        int pullNum;
        Map<String, Map<String, Integer>> offsets = new ConcurrentHashMap<>();
    ...
    public static void main(String[] args) throws Exception {
        ...
        for (int i = 0; i < ts.length; i++) {
            ...
            if(i != 3 && i != 4) {
                al.add(Constants.TOPIC_PRE + i);
                al.add(Constants.TOPIC_PRE + (i+1));
            }

            ts[i] = new ConsumerTask(Constants.QUEUE_PRE + i, al);
        }
